...
MiscSec5:AddButton('Anti Vote Kick', function()
	local min_count = 2
repeat wait() until game:IsLoaded()
...
ThemeManager:SetFolder('Vinix Hub')
SaveManager:SetFolder('Vinix Hub/main')
...
OthersSettings:AddInput('uinamechange', {Default = 'Vinix Hub', Numeric = false, Finished = false, Text = 'Window Title', Tooltip = 'Changes window title', Placeholder = '. . .'})
...
Library:Notify('Finished Loading! Welcome ' ..localPlayer.Name.. ' to Vinix Hub!');
